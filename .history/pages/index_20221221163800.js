    ...
    <>
      ...
      <main className="bg-primary text-black">
        <section className=" min-h-screen p-2 ">
          ...
          <div className="p-10 mb-4 md:ml-5 ml-0">
            ...
            <div className=" font-dosis md:mt-10 mt-28 z-20 text-white ">
          ...
          <div className="flex justify-center  h-24 overflow-hidden md:m-32 m-10 bg-white rounded-2xl ">
              <h1 className="flex align-baseline text-2xl">**Live Registration</h1>
          </div>
        </section>
      </main>
    </>
