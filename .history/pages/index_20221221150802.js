  ...
  return (
    <>
      ...
      <main className="bg-primary ">
        <section className=" min-h-screen p-2 relativ">
          ...
          <Image
            src={stars}
            alt="stars"
            className="md:w-auto md:h-auto absolute left-0 bottom-0 md:right-0 md:mt-0 mt-80  "
          />
          ...
          <div className="p-10 mb-4">
            ...
            <div className=" fle font-dosis md:mt-10 mt-28 z-20 ">
