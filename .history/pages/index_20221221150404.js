      ...
      <main className="bg-primary ">
        <section className=" min-h-screen p-2 ">
          ...
          <Image
            src={stars}
            alt="stars"
            className="md:w-auto md:h-auto absolute  md:right-0 md:mt-0 mt-80  "
          />
          ...
          <div className="p-10 mb-4">
            <div className="  text-black">
              ...
              <div className="mb-4 font-dosis">
                <h1 className="md:text-8xl text-5xl">Nebula</h1>
                <h1 className="md:text-8xl text-5x">
            ...
            <div className=" fle font-dosis mt-10 ">
              <button className="bg-secondary p-2 pl-5 pr-5 md:mr-4 mr-2 rounded-lg">Go to dashboard</button>
              <button className="bg-secondary p-2 pl-5 pr-5 rounded-lg">Join discord</button>
            </div>
          </div>
        </section>
      </main>
