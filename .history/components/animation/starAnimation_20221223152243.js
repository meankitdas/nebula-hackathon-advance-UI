...
function Scene({ numStars = 100 }) {
    ...
    var yAngle = useTransform(scrollYProgress, [0, 1], [0.00, degreesToRadians(180)]);
    var distance = useTransform(scrollYProgress, [0, 1], [10, 3]);
    var time = useTime();
...
export default function StarAnimation() {
  return (
    <div className="container fixed w-80 h-80 right-0">
