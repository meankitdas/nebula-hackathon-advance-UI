...
export default function MainPage() {
  ...
  return (
    <section className=" min-h-screen p-2 " id="about">
      ...
      <nav className="bg-ourwhite min-w-screen h-14 mx-10 rounded-2xl relative  text-black text-sm overflow-hidden hidden lg:block md:block">
        <Navbar />
      </nav>
      ...
      <div className="relative">
        ...
        />
        <div className="flex justify-center items-center h-24 overflow-hidden md:m-32 md:mb-5 m-10 bg-ourwhite rounded-2xl ">
