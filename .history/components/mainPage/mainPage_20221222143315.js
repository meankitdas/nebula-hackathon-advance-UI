...
export default function MainPage() {
  ...
  let z = useTransform(scrollYProgress, [0, 0.5, 1], [0, 0, 0]);

  let y = useTransform(scrollYProgress, [0, 1], ["0%", "20%"]);

  return (
    <motion.section style={{ y }} className=" min-h-screen p-2 " id="about">
      ...
      {/* live section */}
      <motion.div className="relative" style={{x, z, scale, opacity}}>
        <Image
          src={Mark}
