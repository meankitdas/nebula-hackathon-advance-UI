...
export default function SpeakerPage() {
  function ParallaxText(_a) {
     ...
     */
    return (
      <div className="parallax overflow-hidden -tracking-wider leading-8 m-0 whitespace-nowrap flex flex-nowrap">
        <motion.div
  ...
  return (
    <section className=" min-h-screen p-0  bg-white  md:block" id="speaker">
      <div className="text-secondary text-5xl relative font-bungee ">
      ...
      <div className=" h-screen ">
        ...
        <div className="text-secondary text-5xl relative font-bungee ">
        <ParallaxText baseVelocity={-2}>India's Biggest hackathon</ParallaxText>
          {/* <ParallaxText baseVelocity={2}>nebula hackathon</ParallaxText> */}
        </div>
        {/* theme  */}
