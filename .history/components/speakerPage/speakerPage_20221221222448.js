    ...
    <section className=" min-h-screen p-0  bg-white  md:block" id="speaker">
      <div className=" h-screen ">
        ...
        <div className="flex w-full h-1/2 bg-primary">
          <div className="md:w-1/3 w-2/3 flex text-xs md:text-sm justify-center items-center m-2 md:p-10 md:mlhshshshhshsshshsshshshshsshshshshshshhshshhshshshshshshhshshshshh-20">
