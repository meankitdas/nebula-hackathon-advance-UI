    ...
    >
      <div className=" h-screen ">
        <div className="flex w-full h-1/2 ">
          <div className="w-2/3 flex flex-col md:text-8xl items-center justify-center ">
            <div className="text-secondary">
              <h1>Birth of</h1>
              <h1>Innovator</h1>
            </div>
          </div>
          <div className="w-1/3 absolute right-0 flex text-xs justify-center items-center md:p-10 mr-20">
            <p>
