    ...
    <section className=" min-h-screen p-0  bg-white  md:block" id="speaker">
      <div className=" h-screen ">
        <div className="flex w-full h-1/2 ">
          <div className="md:w-2/3 w-1/2 flex flex-col md:text-8xl items-center justify-center ">
            <div className="text-secondary">
              <h1>Birth of</h1>
              <h1>Innovator</h1>
            </div>
          </div>
          <div className="md:w-1/3 w-1/2 flex text-xs md:text-sm justify-center items-center md:p-10 mr-20">
            <p>
